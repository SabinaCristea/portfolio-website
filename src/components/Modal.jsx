...
function Modal({ children, onClose, style, className }) {
  const ref = useOutsideClick(onClose);

  return createPortal(
    <div
      className={`fixed top-0 left-0 w-[100%] h-[100%] backdrop-blur-[3rem] z-[1000] transition-all duration-[0.5s] ${onClose || "overflow-hidden"}`}
    >
      <div
