...
function SkillsPage() {
  return (
    <div className="flex flex-col items-center">
      <header className="text-center mt-[5rem] md:mt-[5rem] lg:mt-[8rem] text-[2.2rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[3.5rem] xl:text-[4rem] sm:leading-[4.5rem] drop-shadow-3xl w-[32rem] sm:w-[auto]">
